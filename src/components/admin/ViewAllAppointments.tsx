...
import { CalendarDots, Clock, UserCircle, Stethoscope } from '@phosphor-icons/react'
...
export default function ViewAllAppointments() {
  ...
  const acceptedAppointments = sortedAppointments.filter((apt) => apt.status === 'accepted')
    ...
    <div>
      <Tabs defaultValue="all">
        <TabsList className="grid w-full grid-cols-5">
          <TabsTrigger value="all">All ({sortedAppointments.length})</TabsTrigger>
